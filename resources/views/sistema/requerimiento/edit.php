...
<form action="{{ @route('api.agenda-cita.update', $cita->id) }}" 
	...
	<input type="text" name="estado_anterior" class = "form-control"
		value="{{ $requerimiento->estado_anterior }}"/>
	...
	<input type="text" name="fecha_modificacion" class = "form-control"
	value="{{ $requerimiento->fecha_modificacion }}"/>

	<input type="text" name="fecha" class = "form-control"
	value="{{ $requerimiento->fecha}}"/>
